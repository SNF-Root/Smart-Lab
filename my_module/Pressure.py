...
class Pressure:
    ...
    def genReport(self):
        ...
        # self.readDir()
        file_path = "/Users/andrew/Desktop/SNF Projects/Tool-Data/data/Output_Text/Pressure Report.txt"
...
def main():
    pressure = Pressure("/Users/andrew/Desktop/SNF Projects/Tool-Data/data/Pressure-Data")
    pressure.initialize()
    pressure.sendData()
