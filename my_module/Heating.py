...
class Heating:
    ...
    def genReport(self):
        ...
        # self.readDir()
        file_path = "/Users/andrew/Desktop/SNF Projects/Tool-Data/data/Output_Text/Heating Report.txt"
...
def main():
    heating = Heating("/Users/andrew/Desktop/SNF Projects/Tool-Data/data/Heating-Data")
    heating.initialize()
    heating.sendData()
